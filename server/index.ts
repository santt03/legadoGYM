...
// La aplicación de escritorio carga la web compilada desde este mismo origen.
app.use('/assets/*', serveStatic({ root: './dist' }))
app.get('/', serveStatic({ path: './dist/index.html' }))

if (!process.env.DATABASE_URL) {
  console.error('Falta DATABASE_URL. Copiá .env.example a .env y configurá PostgreSQL.')
  process.exit(1)
}
